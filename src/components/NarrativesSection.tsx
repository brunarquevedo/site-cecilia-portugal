export default function NarrativesSection() {
  return (
    <section id="narrativas" className="bg-[#968364] py-20 sm:py-24 md:py-32 relative border-y border-[#968364]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">

        {/* Section Header */}
        <div className="text-center space-y-2 mb-12 sm:mb-16">
          <span className="font-sans text-xs uppercase tracking-[0.25em] text-[#F1ECE8]/80 font-medium">
            NARRATIVAS
          </span>
        ...
        <div className="border border-[#F1ECE8]/30 p-8 sm:p-12 md:p-16 rounded-md space-y-6 text-base sm:text-lg text-[#F1ECE8] font-light leading-relaxed">
          ...
          <p>
            Aprendi ao longo da vida que os acontecimentos têm impactos e sensações diferentes em cada pessoa. Um fato pode ser banal para uma e, para outra, ser fonte de grande sofrimento. Só eu sei o quanto de arrependimento, tristeza e vergonha eu carreguei. Tem coisas que até hoje não gosto de lembrar, porque mesmo com o tempo ainda doem lá no fundo.
          </p>
          <p>
            Quando a adolescência foi passando e os 20 chegando, eu continuava com aquela mágoa de mim mesma. Por muito tempo invejei a tranquilidade de várias amigas minhas, que não passaram por tantas turbulências quanto eu (pelo menos que eu saiba).
          </p>
          <p className="font-serif italic text-lg sm:text-xl text-white/90 py-2">
